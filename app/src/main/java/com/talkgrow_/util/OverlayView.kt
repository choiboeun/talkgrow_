    ...
    override fun draw(canvas: Canvas) {
        ...
        results?.let { handLandmarkerResult ->
            ...
            for (landmark in handLandmarkerResult.landmarks()) {
                for (pt in landmark) {
                    canvas.drawCircle(
                        pt.x() * imageWidth * scaleX + offsetX,
                        pt.y() * imageHeight * scaleY + offsetY,
                        8f,
                        pointPaint
                    )
                }
                ...
                HandLandmarker.HAND_CONNECTIONS.forEach {
                    ...
                    canvas.drawLine(
                        start.x() * imageWidth * scaleX + offsetX,
                        start.y() * imageHeight * scaleY + offsetY,
                        end.x() * imageWidth * scaleX + offsetX,
                        end.y() * imageHeight * scaleY + offsetY,
                        linePaint
                    )
                }
            }
